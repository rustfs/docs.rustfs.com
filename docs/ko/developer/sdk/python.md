---
title: "Python SDK"
description: "이 문서는 주로 RustFS에서 Python SDK 사용에 대해 설명합니다."
---

다음은 **RustFS S3 Python SDK(Boto3) 사용 완전 문서**로, 설치, 연결, 기본 작업, 고급 기능(사전 서명된 URL 및 멀티파트 업로드) 등을 포함하며, Python으로 RustFS와 통합하는 개발자에게 적용됩니다.
...
RustFS는 Amazon S3 프로토콜 호환 객체 스토리지 서비스로, Python [Boto3](https://boto3.amazonaws.com/v1/documentation/api/latest/index.html) SDK를 통해 액세스할 수 있습니다.

이 튜토리얼은 Python을 RustFS와 통합하고 Boto3을 통해 다음 작업을 수행하는 방법을 설명합니다:
