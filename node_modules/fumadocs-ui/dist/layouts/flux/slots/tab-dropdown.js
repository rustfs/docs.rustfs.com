...
function TabDropdown({ tabs, placeholder, className, ...props }) {
	...
	return /* @__PURE__ */ jsxs(Popover, {
		...
		children: [item && /* @__PURE__ */ jsxs(PopoverTrigger, {
			className: cn("flex items-center gap-2 rounded-xl overflow-hidden p-1.5 border shadow-sm text-sm text-start transition-colors hover:bg-fd-accent hover:text-fd-accent-foreground data-[popup-open]:bg-fd-accent data-[popup-open]:text-fd-accent-foreground", className),
			...props,
