...
declare function SearchProvider<DialogProps extends SharedProps = DefaultSearchDialogProps>({ SearchDialog, children, options, hotKey, links }: SearchProviderProps<DialogProps>): import("react").JSX.Element;
/**
