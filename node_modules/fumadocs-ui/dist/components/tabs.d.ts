...
declare function TabsList({ className, ...props }: React$1.ComponentProps<typeof TabsList$1>): React$1.JSX.Element;
declare function TabsTrigger({ className, ...props }: React$1.ComponentProps<typeof TabsTrigger$1>): React$1.JSX.Element;
