...
import { detectFsRouterUsage, generateFsRouterTypes } from '../vite-plugins/fs-router-typegen.js';
import { loadConfig, loadDotEnv } from './loader.js';
loadDotEnv();
export async function runRouter(subCommand) {
...
//# sourceMappingURL=cmd-router.js.map