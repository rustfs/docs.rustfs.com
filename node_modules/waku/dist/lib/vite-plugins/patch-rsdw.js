...
const virtualId = (source)=>'\0' + source;
const isVitePluginRscImporter = (importer)=>/(^|[/\\])@vitejs[/\\]plugin-rsc[/\\]/.test(importer || '');
export function patchRsdwPlugin() {
    return {
        ...
        resolveId (source, importer, _options) {
            ...
            if ((source === RSDW_CLIENT_EDGE_ID || source === RSDW_SERVER_EDGE_ID) && !isVitePluginRscImporter(importer)) {
                return virtualId(source);
            }
        },
        load (id) {
...
//# sourceMappingURL=patch-rsdw.js.map