...
export default process.env.VERCEL ? vercelAdapter : process.env.NETLIFY ? netlifyAdapter : process.env.CLOUDFLARE || process.env.WORKERS_CI ? cloudflareAdapter : nodeAdapter;
