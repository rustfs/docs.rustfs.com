...
- Follow the complete [AWS CLI example](/developer/examples/aws-cli).
- Choose an [S3 SDK](/developer/sdk) for application integration.
- Configure [credentials and access policies](/operations/credentials).
- Enable [TLS](/integration/tls-configured) before exposing the endpoint outside a trusted network.
