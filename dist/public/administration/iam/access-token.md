# RustFS Access Key Management (/administration/iam/access-token)
...
<img alt="access key list page" src="__img0" />

## Deleting Access Keys [#deleting-access-keys]
...
<img alt="access key deletion" src="__img1" />
