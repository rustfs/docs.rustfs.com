# Nginx Reverse Proxy (/integration/nginx)
...
<Callout type="warn" title="Key configuration items">
...
## Multi-Machine Load Balancing [#multi-machine-load-balancing]
