...
//#region content/features/huaweicloud/images/sec1-1.png
var import_jsx_runtime_react_server = require_jsx_runtime_react_server();
var sec1_1_default = "/assets/sec1-1-Cy36oRiV.png";
//#endregion
//#region content/features/huaweicloud/index.md?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "three-reasons-customers-run-rustfs-on-huawei-cloud-cce",
			"content": "Running RustFS on CCE provides flexible control over the software stack, avoiding cloud lock-in."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-huawei-cloud-cce",
			"content": "Huawei Cloud Container Engine for Kubernetes (CCE) is a fully managed Kubernetes service that provides high-performance, high-availability container clusters for enterprise applications. CCE integrates with Huawei Cloud's infrastructure and services, providing a comprehensive container platform solution."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-huawei-cloud-cce",
			"content": "RustFS natively integrates with CCE, making it easier to operate your own large-scale multi-tenant object storage as a service. RustFS Operator works with CCE toolchain (such as CCE console and Huawei Cloud Container Registry) to help you maximize the value of the CCE ecosystem."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-huawei-cloud-cce",
		...
		},
		{
			...
			"content": "A key requirement for deploying RustFS at scale on Huawei Cloud CCE is capability tiers across storage classes (NVMe, HDD, public cloud). This enables enterprises to manage both cost and performance simultaneously."
		},
		{
			"heading": "storage-classes-and-tiering",
		...
		{
			"heading": "storage-classes-and-tiering",
			"content": "RustFS provides secure storage in CCE hybrid clouds by encrypting objects at the source, ensuring customers always have complete control over data. When CCE is deployed in public clouds, tiering capabilities help CCE effectively manage data across persistent block storage and cheaper object storage tiers."
		},
		{
			"heading": "storage-classes-and-tiering",
			"content": "**Learn More:**"
		...
		},
		{
			...
			"content": "CCE does not provide native key management capabilities. RustFS recommends using HashiCorp Vault to store keys outside the object storage system. This is a best practice for cloud-native applications."
		},
		{
			"heading": "encryption-key-management",
		...
		},
		{
			...
			"content": "When running RustFS on CCE, customers can manage single sign-on (SSO) through third-party OpenID Connect/LDAP compatible identity providers (such as Keycloak, Okta/Auth0, Google, Facebook, ActiveDirectory, and OpenLDAP). RustFS recommends OpenID Connect-compatible Keycloak IDP."
		},
		{
			"heading": "identity-management",
		...
		{
			"heading": "certificate-management",
			"content": "RustFS integrates with CCE certificate manager, so you can use the RustFS operator to automatically provision, configure, manage, and update certificates for RustFS tenants. Tenants are completely isolated from each other in their own Kubernetes namespaces with their own certificates for enhanced security."
		},
		{
	...
	"headings": [
		{
			"id": "three-reasons-customers-run-rustfs-on-huawei-cloud-cce",
			"content": "Three Reasons Customers Run RustFS on Huawei Cloud CCE"
		},
		{
			"id": "rustfs-operator-natively-integrates-with-cce-features",
			"content": "RustFS Operator Natively Integrates with CCE Features"
		},
		{
			"id": "feature-overview",
...
var toc = [
	{
		depth: 2,
		url: "#three-reasons-customers-run-rustfs-on-huawei-cloud-cce",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Three Reasons Customers Run RustFS on Huawei Cloud CCE" })
	},
	{
		depth: 2,
		url: "#rustfs-operator-natively-integrates-with-cce-features",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "RustFS Operator Natively Integrates with CCE Features" })
	},
	{
		depth: 3,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "three-reasons-customers-run-rustfs-on-huawei-cloud-cce",
			children: "Three Reasons Customers Run RustFS on Huawei Cloud CCE"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "Running RustFS on CCE provides flexible control over the software stack, avoiding cloud lock-in." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Huawei Cloud Container Engine for Kubernetes (CCE) is a fully managed Kubernetes service that provides high-performance, high-availability container clusters for enterprise applications. CCE integrates with Huawei Cloud's infrastructure and services, providing a comprehensive container platform solution." }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS natively integrates with CCE, making it easier to operate your own large-scale multi-tenant object storage as a service. RustFS Operator works with CCE toolchain (such as CCE console and Huawei Cloud Container Registry) to help you maximize the value of the CCE ecosystem." }),
		"\n",
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "rustfs-operator-natively-integrates-with-cce-features",
			children: "RustFS Operator Natively Integrates with CCE Features"
		}),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "A key requirement for deploying RustFS at scale on Huawei Cloud CCE is capability tiers across storage classes (NVMe, HDD, public cloud). This enables enterprises to manage both cost and performance simultaneously." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS provides secure storage in CCE hybrid clouds by encrypting objects at the source, ensuring customers always have complete control over data. When CCE is deployed in public clouds, tiering capabilities help CCE effectively manage data across persistent block storage and cheaper object storage tiers." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "CCE does not provide native key management capabilities. RustFS recommends using HashiCorp Vault to store keys outside the object storage system. This is a best practice for cloud-native applications." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS integrates with CCE certificate manager, so you can use the RustFS operator to automatically provision, configure, manage, and update certificates for RustFS tenants. Tenants are completely isolated from each other in their own Kubernetes namespaces with their own certificates for enhanced security." }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "monitoring-and-alerting",
