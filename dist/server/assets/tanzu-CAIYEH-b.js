...
//#region content/features/tanzu/images/sec1-1.png
var import_jsx_runtime_react_server = require_jsx_runtime_react_server();
var sec1_1_default = "/assets/sec1-1-Cy36oRiV.png";
//#endregion
//#region content/features/tanzu/index.md?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "three-reasons-customers-run-rustfs-on-vmware-tanzu",
			"content": "Running RustFS on Tanzu provides control over the software stack with the flexibility needed to avoid cloud lock-in."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-vmware-tanzu",
			"content": "VMware Tanzu is an enterprise-grade Kubernetes container platform with full-stack automated operations capabilities that can manage hybrid cloud, multi-cloud, and edge deployments. VMware Tanzu includes enterprise-grade Linux operating systems, container runtimes, networking, monitoring, registries, and authentication and authorization solutions."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-vmware-tanzu",
			"content": "RustFS natively integrates with VMware Tanzu, making it easier to operate your own large-scale multi-tenant object storage as a service. RustFS Operator works with the VMware Tanzu toolchain (such as VMware Tanzu Cluster Manager CLI and Quay container registry) to help you maximize the value of the VMware Tanzu ecosystem."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-vmware-tanzu",
		...
		},
		{
			...
			"content": "A key requirement for deploying RustFS at scale on VMware Tanzu is capability tiers across storage classes (NVMe, HDD, public cloud). This enables enterprises to manage both cost and performance simultaneously."
		},
		{
			"heading": "storage-classes-and-tiering",
		...
		{
			"heading": "storage-classes-and-tiering",
			"content": "RustFS provides secure storage in VMware Tanzu hybrid clouds by encrypting objects at the source, ensuring customers always have complete control over data. When VMware Tanzu is deployed in public clouds, tiering capabilities help VMware Tanzu effectively manage data across persistent block storage and cheaper object storage tiers."
		},
		{
			"heading": "storage-classes-and-tiering",
			"content": "**Learn More:**"
		...
		{
			"heading": "encryption-key-management",
			"content": "For all production environments, we recommend enabling encryption on all storage buckets by default. RustFS uses AES-256-GCM or ChaCha20-Poly1305 encryption to protect data integrity and confidentiality with negligible performance impact."
		},
		{
			"heading": "encryption-key-management",
		...
		},
		{
			...
			"content": "All traffic from applications to RustFS, including inter-node traffic, is encrypted using TLS. TLS certificates are used to protect network communication and establish the identity of network-connected resources, such as RustFS server domains."
		},
		{
			"heading": "certificate-management",
		...
		{
			"heading": "monitoring-and-alerting",
			"content": "External monitoring solutions regularly scrape RustFS Prometheus endpoints. RustFS recommends using Grafana or platform monitoring components installed in the OpenShift-user-workload-monitoring project to connect to RustFS. These same tools can also be used to establish baselines and set notification alert thresholds, which can then be routed to notification platforms such as PagerDuty, Freshservice, or even SNMP."
		},
		{
		...
		{
			"heading": "logging-and-auditing",
			"content": "*This page is pending translation. Refer to the Chinese documentation.*"
		}
	],
	"headings": [
		{
			"id": "three-reasons-customers-run-rustfs-on-vmware-tanzu",
			"content": "Three Reasons Customers Run RustFS on VMware Tanzu"
		},
		{
			"id": "rustfs-operator-natively-integrates-with-vmware-tanzu-features",
			"content": "RustFS Operator Natively Integrates with VMware Tanzu Features"
		},
		{
			"id": "feature-overview",
...
var toc = [
	{
		depth: 2,
		url: "#three-reasons-customers-run-rustfs-on-vmware-tanzu",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Three Reasons Customers Run RustFS on VMware Tanzu" })
	},
	{
		depth: 2,
		url: "#rustfs-operator-natively-integrates-with-vmware-tanzu-features",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "RustFS Operator Natively Integrates with VMware Tanzu Features" })
	},
	{
		depth: 3,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "three-reasons-customers-run-rustfs-on-vmware-tanzu",
			children: "Three Reasons Customers Run RustFS on VMware Tanzu"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "Running RustFS on Tanzu provides control over the software stack with the flexibility needed to avoid cloud lock-in." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "VMware Tanzu is an enterprise-grade Kubernetes container platform with full-stack automated operations capabilities that can manage hybrid cloud, multi-cloud, and edge deployments. VMware Tanzu includes enterprise-grade Linux operating systems, container runtimes, networking, monitoring, registries, and authentication and authorization solutions." }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS natively integrates with VMware Tanzu, making it easier to operate your own large-scale multi-tenant object storage as a service. RustFS Operator works with the VMware Tanzu toolchain (such as VMware Tanzu Cluster Manager CLI and Quay container registry) to help you maximize the value of the VMware Tanzu ecosystem." }),
		"\n",
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "rustfs-operator-natively-integrates-with-vmware-tanzu-features",
			children: "RustFS Operator Natively Integrates with VMware Tanzu Features"
		}),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "A key requirement for deploying RustFS at scale on VMware Tanzu is capability tiers across storage classes (NVMe, HDD, public cloud). This enables enterprises to manage both cost and performance simultaneously." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS provides secure storage in VMware Tanzu hybrid clouds by encrypting objects at the source, ensuring customers always have complete control over data. When VMware Tanzu is deployed in public clouds, tiering capabilities help VMware Tanzu effectively manage data across persistent block storage and cheaper object storage tiers." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "For all production environments, we recommend enabling encryption on all storage buckets by default. RustFS uses AES-256-GCM or ChaCha20-Poly1305 encryption to protect data integrity and confidentiality with negligible performance impact." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "All traffic from applications to RustFS, including inter-node traffic, is encrypted using TLS. TLS certificates are used to protect network communication and establish the identity of network-connected resources, such as RustFS server domains." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "External monitoring solutions regularly scrape RustFS Prometheus endpoints. RustFS recommends using Grafana or platform monitoring components installed in the OpenShift-user-workload-monitoring project to connect to RustFS. These same tools can also be used to establish baselines and set notification alert thresholds, which can then be routed to notification platforms such as PagerDuty, Freshservice, or even SNMP." }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "logging-and-auditing",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: (0, import_jsx_runtime_react_server.jsxs)(_components.em, { children: [
			"This page is pending translation. Refer to the ",
			(0, import_jsx_runtime_react_server.jsx)(_components.a, {
				href: "https://docs.rustfs.com.cn",
				children: "Chinese documentation"
			}),
			"."
		] }) })
	] });
