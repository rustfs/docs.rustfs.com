...
//#region content/installation/windows/images/windows-setup.jpg
var import_jsx_runtime_react_server = require_jsx_runtime_react_server();
var windows_setup_default = "/assets/macos-setup-DjUxT1xa.jpg";
//#endregion
//#region content/installation/windows/images/setting.jpg
var setting_default = "/assets/setting-CMbOzEQE.jpg";
//#endregion
//#region content/installation/windows/index.md?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "1-preparation",
			"content": "Windows startup **mode** only supports single-node single-disk mode, more suitable for development, debugging, and testing environments."
		},
		{
			"heading": "1-preparation",
			"content": ":::"
		...
		},
		{
			...
			"content": "Please confirm that this program has relevant execution permissions in the Windows operating system."
		},
		{
			"heading": "double-click-the-startup-icon",
		...
		{
			"heading": "4-modify-configuration",
		...
		{
			"heading": "5-access-console",
			"content": "Port `7001` applies to the Windows desktop launcher. If you run the standalone `rustfs` server binary instead, the console listens on port `9001` by default."
		},
		{
			"heading": "5-access-console",
			"content": ":::"
	...
	"headings": [
		...
		{
			"id": "double-click-the-startup-icon",
			"content": "Double-click the Startup Icon"
		},
		{
			"id": "4-modify-configuration",
			"content": "4\\. Modify Configuration"
		},
		{
			"id": "5-access-console",
			"content": "5\\. Access Console"
		}
	]
};
var toc = [
	...
	{
		depth: 2,
		url: "#double-click-the-startup-icon",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Double-click the Startup Icon" })
	},
	{
		depth: 2,
		url: "#4-modify-configuration",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Modify Configuration" }),
		_step: 1
	},
	{
		depth: 2,
		url: "#5-access-console",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsxs)(_components.div, {
			...
			children: [
					...
					children: [
						...
						(0, import_jsx_runtime_react_server.jsx)(Callout, {
							...
							children: (0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
								"Windows startup ",
								(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "mode" }),
								" only supports single-node single-disk mode, more suitable for development, debugging, and testing environments."
							] })
						}),
						(0, import_jsx_runtime_react_server.jsxs)(_components.ol, { children: [
							...
							(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
								...
								(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
									"For detailed introduction about startup modes, please refer to ",
							...
							(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
								"\n",
								(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Download the installation package, modify permissions, and start." }),
								"\n"
							] }),
							"\n"
						] })
				...
				(0, import_jsx_runtime_react_server.jsxs)(_components.div, {
					...
					}), (0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Please confirm that this program has relevant execution permissions in the Windows operating system." })]
				})
			]
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "double-click-the-startup-icon",
			children: "Double-click the Startup Icon"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.ol, { children: [
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"\n",
				(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Double-click the startup icon;" }),
				"\n"
			] }),
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"\n",
				(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Click configure disk;" }),
				"\n"
			] }),
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"\n",
				(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Click \"Start Service\", and RustFS service starts successfully." }),
				"\n"
			] }),
			"\n"
		] }),
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: (0, import_jsx_runtime_react_server.jsx)(_components.img, {
			alt: "windows startup",
			src: windows_setup_default
		}) }),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.div, {
			className: "fd-steps",
			children: [(0, import_jsx_runtime_react_server.jsxs)(_components.div, {
				className: "fd-step",
				children: [
					(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
						id: "4-modify-configuration",
					...
					(0, import_jsx_runtime_react_server.jsxs)(_components.ol, { children: [
						...
						(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Server default port;" }),
							"\n"
						] }),
						"\n",
						(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Default administrator username and password;" }),
							"\n"
						] }),
						"\n",
						(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Specified disk directory;" }),
							"\n"
						] }),
						"\n"
					] }),
					(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: (0, import_jsx_runtime_react_server.jsx)(_components.img, {
						alt: "RustFS windows configuration",
						src: setting_default
					}) })
				]
			}), (0, import_jsx_runtime_react_server.jsxs)(_components.div, {
				...
				children: [
					...
					(0, import_jsx_runtime_react_server.jsx)(Callout, {
						...
						children: (0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
							...
							" applies to the Windows desktop launcher. If you run the standalone ",
