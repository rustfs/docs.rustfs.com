...
//#region content/features/aws-elastic/images/sec1-1.png
var import_jsx_runtime_react_server = require_jsx_runtime_react_server();
var sec1_1_default = "/assets/sec1-1-Cy36oRiV.png";
//#endregion
//#region content/features/aws-elastic/index.md?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "three-reasons-customers-run-rustfs-on-amazon-eks",
			"content": "Running RustFS on EKS provides control over the software stack with the flexibility needed to avoid cloud lock-in."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-amazon-eks",
			"content": "Amazon Elastic Kubernetes Service (Amazon EKS) is a managed service that makes it easy for you to run Kubernetes on AWS without needing to install, operate, and maintain your own Kubernetes control plane or nodes."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-amazon-eks",
			"content": "RustFS natively integrates with Amazon EKS, making it easier to operate your own large-scale multi-tenant object storage as a service. RustFS Operator works with the Amazon EKS toolchain to help you maximize the value of the AWS ecosystem."
		},
		{
			"heading": "three-reasons-customers-run-rustfs-on-amazon-eks",
		...
		},
		{
			...
			"content": "A key requirement for deploying RustFS at scale on Amazon EKS is capability tiers across storage classes (NVMe, HDD, public cloud). This enables enterprises to manage both cost and performance simultaneously."
		},
		{
			"heading": "storage-classes-and-tiering",
			"content": "RustFS supports automatic transition of aging objects from fast NVMe tiers to more cost-effective HDD tiers, and even to cost-optimized cold public cloud storage tiers (like AWS S3 Glacier)."
		},
		{
			"heading": "storage-classes-and-tiering",
		...
		{
			"heading": "storage-classes-and-tiering",
			"content": "RustFS provides secure storage in Amazon EKS hybrid clouds by encrypting objects at the source, ensuring customers always have complete control over data. When Amazon EKS is deployed in public clouds, tiering capabilities help Amazon EKS effectively manage data across persistent block storage (EBS) and cheaper object storage tiers."
		},
		{
			"heading": "storage-classes-and-tiering",
			"content": "**Learn More:**"
	...
	"headings": [
		{
			"id": "three-reasons-customers-run-rustfs-on-amazon-eks",
			"content": "Three Reasons Customers Run RustFS on Amazon EKS"
		},
		{
			"id": "rustfs-operator-natively-integrates-with-amazon-eks-features",
			"content": "RustFS Operator Natively Integrates with Amazon EKS Features"
		},
		{
			"id": "feature-overview",
...
var toc = [
	{
		depth: 2,
		url: "#three-reasons-customers-run-rustfs-on-amazon-eks",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Three Reasons Customers Run RustFS on Amazon EKS" })
	},
	{
		depth: 2,
		url: "#rustfs-operator-natively-integrates-with-amazon-eks-features",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "RustFS Operator Natively Integrates with Amazon EKS Features" })
	},
	{
		depth: 3,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "three-reasons-customers-run-rustfs-on-amazon-eks",
			children: "Three Reasons Customers Run RustFS on Amazon EKS"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "Running RustFS on EKS provides control over the software stack with the flexibility needed to avoid cloud lock-in." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Amazon Elastic Kubernetes Service (Amazon EKS) is a managed service that makes it easy for you to run Kubernetes on AWS without needing to install, operate, and maintain your own Kubernetes control plane or nodes." }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS natively integrates with Amazon EKS, making it easier to operate your own large-scale multi-tenant object storage as a service. RustFS Operator works with the Amazon EKS toolchain to help you maximize the value of the AWS ecosystem." }),
		"\n",
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "rustfs-operator-natively-integrates-with-amazon-eks-features",
			children: "RustFS Operator Natively Integrates with Amazon EKS Features"
		}),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "A key requirement for deploying RustFS at scale on Amazon EKS is capability tiers across storage classes (NVMe, HDD, public cloud). This enables enterprises to manage both cost and performance simultaneously." }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS supports automatic transition of aging objects from fast NVMe tiers to more cost-effective HDD tiers, and even to cost-optimized cold public cloud storage tiers (like AWS S3 Glacier)." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS provides secure storage in Amazon EKS hybrid clouds by encrypting objects at the source, ensuring customers always have complete control over data. When Amazon EKS is deployed in public clouds, tiering capabilities help Amazon EKS effectively manage data across persistent block storage (EBS) and cheaper object storage tiers." }),
		"\n",
