...
//#region content/developer/mc.md?collection=docs
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The MinIO Client (`mc`) is a command-line tool for managing object storage services. It supports MinIO, Amazon S3, and other S3-compatible services. As RustFS is S3-compatible, you can use `mc` to manage RustFS objects."
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "An available RustFS instance. Refer to the Installation Guide."
		},
		{
			"heading": void 0,
			"content": "The `mc` tool is installed."
		},
		{
			"heading": void 0,
			"content": "Available access keys."
		},
		{
			"heading": "using-mc-with-rustfs",
			"content": "First, configure an alias for RustFS using the `mc alias` command:"
		},
		{
			"heading": "using-mc-with-rustfs",
			"content": "Output:"
		...
		{
			"heading": "using-mc-with-rustfs",
			"content": "You can now use `mc` with the `rustfs` alias to create/delete buckets, upload/download files, etc."
		},
		{
		...
		{
			"heading": "upload-file",
			"content": "Upload a file to a bucket:"
		},
		{
			"heading": "upload-file",
			"content": "Output:"
		...
		{
			"heading": "delete-file",
			"content": "Delete a file from a bucket:"
		},
		{
			"heading": "delete-file",
			"content": "Output:"
		...
		{
			"heading": "download-file-from-storage",
			"content": "Use `mc get` command to download a file from a bucket:"
		},
		{
			"heading": "download-file-from-storage",
			"content": "Response:"
	...
	"headings": [
		{
			"id": "using-mc-with-rustfs",
			"content": "Using `mc` with RustFS"
		},
		{
			"id": "list-buckets",
		...
		{
			"id": "download-file-from-storage",
			"content": "Download File from Storage"
		}
	]
};
var toc = [
	...
	},
	{
		depth: 3,
		url: "#delete-file",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Delete File" })
	},
	{
		depth: 3,
		url: "#download-file-from-storage",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Download File from Storage" })
	}
];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			...
			") is a command-line tool for managing object storage services. It supports MinIO, Amazon S3, and other S3-compatible services. As RustFS is S3-compatible, you can use ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "mc" }),
			" to manage RustFS objects."
		] }),
		"\n",
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"An available RustFS instance. Refer to the ",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"First, configure an alias for RustFS using the ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "mc alias" }),
			" command:"
		] }),
		"\n",
			...
			children: (0, import_jsx_runtime_react_server.jsx)(_components.code, { children: (0, import_jsx_runtime_react_server.jsxs)(_components.span, {
				...
				children: [
					...
					(0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: " http://12.34.56.78:9000"
					}),
					(0, import_jsx_runtime_react_server.jsx)(_components.span, {
						style: {
							"--shiki-light": "#032F62",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Output:" }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			...
			" alias to create/delete buckets, upload/download files, etc."
		] }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "List all buckets:" }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: (0, import_jsx_runtime_react_server.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime_react_server.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: "[2025-08-01 10:46:24 CST]     0B bucket-creation-by-api/"
					})
				}),
				"\n",
				(0, import_jsx_runtime_react_server.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: "[2025-07-29 09:15:35 CST]     0B rustfs-demo/"
					})
				}),
				"\n",
				(0, import_jsx_runtime_react_server.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: "[2025-08-03 09:44:45 CST]     0B bucket-creation-by-ui/"
					})
				})
			] })
		}) }),
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Upload a file to a bucket:" }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Delete a file from a bucket:" }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: (0, import_jsx_runtime_react_server.jsx)(_components.code, { children: (0, import_jsx_runtime_react_server.jsxs)(_components.span, {
				...
				children: [
					...
					(0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: " rustfs/bucket-creation-by-mc/file_name"
					})
				]
			}) })
		}) }),
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.h3, {
			id: "download-file-from-storage",
			children: "Download File from Storage"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"Use ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "mc get" }),
			" command to download a file from a bucket:"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Response:" }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: (0, import_jsx_runtime_react_server.jsx)(_components.code, { children: (0, import_jsx_runtime_react_server.jsxs)(_components.span, {
				...
				children: [
					...
					(0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: ".eation-by-mc/file_name:"
					}),
					(0, import_jsx_runtime_react_server.jsx)(_components.span, {
						style: {
							"--shiki-light": "#005CC5",
