...
//#region content/installation/linux/multiple-node-multiple-disk.md?collection=docs
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "1-pre-installation-reading",
			"content": "Multiple Node Multiple Disk Mode (MNMD) (current document)"
		},
		{
			"heading": "1-pre-installation-reading",
			"content": "Pre-Installation Checklist to ensure all items meet production guidance. If production standards are not needed, this guidance can be skipped."
		},
		{
			"heading": "1-pre-installation-reading",
			"content": "A minimum of **4 servers** is required, with each server needing at least 1 disk to safely start a distributed object storage cluster."
		},
		{
			"heading": "1-pre-installation-reading",
			"content": "In the following architecture diagram, data is written to any server randomly through load balancing. Using the default 12 + 4 mode, a data block is split into 12 data blocks + 4 parity blocks by default, stored on different disks across different servers."
		},
		{
			"heading": "1-pre-installation-reading",
			"content": "Any single server failure or maintenance will not affect data security."
		},
		{
			"heading": "1-pre-installation-reading",
			"content": "Any data corruption within 4 disks will not affect data security."
		},
		{
		...
		{
			"heading": "2-prerequisites",
			"content": "Host aliases or domain name resolution"
		},
		{
			"heading": "2-prerequisites",
		...
		{
			"heading": "2-prerequisites",
			"content": "File system planning"
		},
		{
			"heading": "21-operating-system-version",
			"content": "We recommend Linux kernel version 4.x and above. Version 5.x/6.x can achieve better I/O throughput and network performance."
		},
		{
			"heading": "21-operating-system-version",
		...
		{
			"heading": "22-firewall",
			"content": "All RustFS servers in the deployment **must** use the same listening port. If you use port 9000, all ports on other servers must also be port 9000."
		},
		{
			"heading": "23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
			"content": "> Single Node Single Disk and Single Node Multiple Disk do not set host aliases, please skip this step."
		},
		{
			"heading": "23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
			"content": "Creating a RustFS cluster requires **identical, sequential** hostnames. There are two ways to achieve sequential hostnames:"
		},
		{
			"heading": "23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
			"content": "**1. DNS Configuration:**"
		},
		{
			"heading": "23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
			"content": "Please configure your DNS resolution server to ensure name continuity."
		},
		{
			"heading": "23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
			"content": "**2. HOSTS Configuration:**"
		},
		{
			"heading": "23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
			"content": "Modify the local alias settings in /etc/hosts as follows:"
		},
		{
			"heading": "24-memory-requirements",
			"content": "RustFS requires at least 2 GB of memory to run in a test environment, and production environments require a minimum of 128 GB of memory."
		},
		{
			"heading": "25-time-synchronization",
			"content": "Multi-node consistency must use time servers to maintain time consistency, otherwise services may not start. Related time servers include `ntp`, `timedatectl`, or `timesyncd`."
		},
		{
			"heading": "25-time-synchronization",
			"content": "RustFS requires time synchronization. You can use the following command to check time synchronization status:"
		},
		{
			"heading": "25-time-synchronization",
		...
		{
			"heading": "26-capacity-and-ec-planning",
			"content": "When planning object storage capacity, we recommend considering:"
		},
		{
			"heading": "26-capacity-and-ec-planning",
		...
		{
			"heading": "26-capacity-and-ec-planning",
			"content": "Planning cycle: How long do you hope this hardware planning can support? (recommended: 3 years)"
		},
		{
			"heading": "26-capacity-and-ec-planning",
		...
		{
			"heading": "26-capacity-and-ec-planning",
			"content": "Recommended Parity Level"
		},
		{
			"heading": "26-capacity-and-ec-planning",
			"content": "Description"
		...
		{
			"heading": "26-capacity-and-ec-planning",
			"content": "Can tolerate up to 4 disk (or node) failures, achieving a good balance between reliability and storage efficiency."
		},
		{
			"heading": "26-capacity-and-ec-planning",
		...
		{
			"heading": "26-capacity-and-ec-planning",
			"content": "EC:4 - 8 or higher"
		},
		{
			"heading": "26-capacity-and-ec-planning",
			"content": "Suitable for scenarios with extremely high data availability requirements, but sacrifices more storage space."
		},
		{
			"heading": "26-capacity-and-ec-planning",
		...
		{
			"heading": "26-capacity-and-ec-planning",
			"content": "Provides basic redundancy protection, suitable for non-critical business."
		},
		{
			"heading": "27-disk-planning",
			"content": "Due to NFS generating phantom writes and lock issues under high I/O conditions, **NFS is prohibited** as the underlying storage medium when using RustFS. The official strongly recommends using &#x2A;*JBOD (Just a Bunch of Disks)** mode, which means simple disk bundling. This means exposing physical disks directly and independently to the operating system, with RustFS software layer responsible for data redundancy and protection."
		},
		{
			"heading": "27-disk-planning",
			"content": "The reasons are as follows:"
		},
		{
			"heading": "27-disk-planning",
			"content": "**Better Performance:** RustFS's Erasure Coding engine is highly optimized and can directly read and write multiple disks concurrently, achieving higher throughput than hardware RAID controllers. Hardware RAID becomes a performance bottleneck."
		},
		{
			"heading": "27-disk-planning",
		...
		{
			"heading": "27-disk-planning",
			"content": "**Simpler Management:** RustFS uniformly manages disks, simplifying storage layer operations and maintenance."
		},
		{
			"heading": "27-disk-planning",
			"content": "**Faster Fault Recovery:** RustFS healing process is faster than traditional RAID rebuild and has less impact on cluster performance."
		},
		{
			"heading": "27-disk-planning",
			"content": "The recommended storage medium is NVMe SSD as your storage medium on disks to ensure higher performance and throughput."
		},
		{
			"heading": "28-file-system-selection",
			"content": "For disk file system formatting, RustFS strongly recommends using XFS file system on all disks used for storage. RustFS development and testing are based on XFS, ensuring optimal performance and stability. Avoid using other file systems such as ext4, BTRFS, or ZFS, as they may cause performance degradation or unpredictable issues."
		},
		{
			"heading": "28-file-system-selection",
			"content": "RustFS is an object storage system designed for high concurrency and high performance. When clients upload or download large objects, RustFS will shard them and read/write to multiple disks in the erasure set in parallel."
		},
		{
			"heading": "28-file-system-selection",
		...
		{
			"heading": "28-file-system-selection",
			"content": "Object storage typically needs to handle massive numbers of files and huge individual files (TB level). XFS is a 64-bit file system that can support extremely large file sizes (up to 8 EB) and file system scale. Its metadata management is very efficient, and even with millions of files in a single directory, its performance degradation is much less than other file systems. This is crucial for RustFS's approach of storing each object (or version of an object) as an independent file on the backend file system."
		},
		{
			"heading": "28-file-system-selection",
		...
		{
			"heading": "28-file-system-selection",
			"content": "Use the following formatting command:"
		},
		{
			"heading": "28-file-system-selection",
		...
		{
			"heading": "28-file-system-selection",
			"content": "-n ftype=1: Enable ftype functionality. This allows the file system to record file types in the directory structure, which can improve performance of operations like readdir and unlink, beneficial for RustFS."
		},
		{
			"heading": "28-file-system-selection",
			"content": "Mounting:"
		},
		{
			...
			"content": "For RustFS startup, we recommend configuring a dedicated user without login permissions to start RustFS services. In the rustfs.service startup control script."
		},
		{
			"heading": "3-configure-username",
			"content": "**Do not modify default startup account:** The default user and group are `root` and `root`. If you want to use the default `root` and `root`, no modification is needed."
		},
		{
			"heading": "3-configure-username",
			"content": "**Modify default startup account:** You can use the groupadd and useradd commands to create users and groups, then modify the username and password in the systemctl startup configuration file after adding."
		},
		{
			"heading": "3-configure-username",
		...
		},
		{
			...
			"content": "Start service and set auto-start"
		},
		{
			"heading": "7-start-service-and-verification",
		...
		{
			"heading": "7-start-service-and-verification",
			"content": "Enter the server's IP address and port to try accessing the console. The interface you see is as follows:"
		}
	],
	"headings": [
		{
			"id": "multiple-node-multiple-disk-mnmd",
			"content": "Multiple Node Multiple Disk (MNMD)"
		},
		{
		...
		{
			"id": "23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
			"content": "2.3. Hostnames (Single Node Single Disk and Single Node Multiple Disk can skip this step)"
		},
		{
			"id": "24-memory-requirements",
			"content": "2.4. Memory Requirements"
		},
		{
			"id": "25-time-synchronization",
			"content": "2.5. Time Synchronization"
		},
		{
			"id": "26-capacity-and-ec-planning",
			"content": "2.6. Capacity and EC Planning"
		},
		{
			"id": "27-disk-planning",
			"content": "2.7. Disk Planning"
		},
		{
			"id": "28-file-system-selection",
			"content": "2.8. File System Selection"
		},
		{
...
var toc = [
	{
		depth: 1,
		url: "#multiple-node-multiple-disk-mnmd",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Multiple Node Multiple Disk (MNMD)" })
	},
	{
		depth: 2,
	...
	{
		depth: 3,
		url: "#23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "2.3. Hostnames (Single Node Single Disk and Single Node Multiple Disk can skip this step)" })
	},
	{
		depth: 3,
		url: "#24-memory-requirements",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "2.4. Memory Requirements" })
	},
	{
		depth: 3,
		url: "#25-time-synchronization",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "2.5. Time Synchronization" })
	},
	{
		depth: 3,
		url: "#26-capacity-and-ec-planning",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "2.6. Capacity and EC Planning" })
	},
	{
		depth: 3,
		url: "#27-disk-planning",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "2.7. Disk Planning" })
	},
	{
		depth: 3,
		url: "#28-file-system-selection",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "2.8. File System Selection" })
	},
	{
		depth: 2,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsx)(_components.h1, {
			id: "multiple-node-multiple-disk-mnmd",
			children: "Multiple Node Multiple Disk (MNMD)"
		}),
		"\n",
			...
			children: [
				(0, import_jsx_runtime_react_server.jsxs)(_components.div, {
					...
					children: [
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "This document covers RustFS multiple node multiple disk mode deployment, which is suitable for enterprise-grade performance, security, and scalability. It also provides architecture diagrams needed for production workloads. Please read before installation. Our startup modes and checklists are as follows:" }),
						(0, import_jsx_runtime_react_server.jsxs)(_components.ol, { children: [
							...
							(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
								...
								(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.a, {
									...
									children: "Pre-Installation Checklist"
								}), " to ensure all items meet production guidance. If production standards are not needed, this guidance can be skipped."] }),
								"\n"
							] }),
							"\n"
						] }),
						(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
							"A minimum of ",
							(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "4 servers" }),
							" is required, with each server needing at least 1 disk to safely start a distributed object storage cluster."
						] }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "In the following architecture diagram, data is written to any server randomly through load balancing. Using the default 12 + 4 mode, a data block is split into 12 data blocks + 4 parity blocks by default, stored on different disks across different servers." }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Any single server failure or maintenance will not affect data security." }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Any data corruption within 4 disks will not affect data security." }),
				...
				(0, import_jsx_runtime_react_server.jsxs)(_components.div, {
					...
					children: [
						...
						(0, import_jsx_runtime_react_server.jsxs)(_components.ol, { children: [
							...
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "Host aliases or domain name resolution" }),
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "Memory requirements" }),
							"\n",
							...
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "File system planning" }),
							"\n"
						] }),
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "We recommend Linux kernel version 4.x and above. Version 5.x/6.x can achieve better I/O throughput and network performance." }),
						...
						(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
							...
							" use the same listening port. If you use port 9000, all ports on other servers must also be port 9000."
						] }),
						(0, import_jsx_runtime_react_server.jsx)(_components.h3, {
							id: "23-hostnames-single-node-single-disk-and-single-node-multiple-disk-can-skip-this-step",
							children: "2.3. Hostnames (Single Node Single Disk and Single Node Multiple Disk can skip this step)"
						}),
						(0, import_jsx_runtime_react_server.jsxs)(_components.blockquote, { children: [
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Single Node Single Disk and Single Node Multiple Disk do not set host aliases, please skip this step." }),
							"\n"
						] }),
						(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
							"Creating a RustFS cluster requires ",
							(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "identical, sequential" }),
							" hostnames. There are two ways to achieve sequential hostnames:"
						] }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: (0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "1. DNS Configuration:" }) }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Please configure your DNS resolution server to ensure name continuity." }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: (0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "2. HOSTS Configuration:" }) }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Modify the local alias settings in /etc/hosts as follows:" }),
						(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
							className: "shiki shiki-themes github-light github-dark",
							style: {
								"--shiki-light": "#24292e",
								...
								(0, import_jsx_runtime_react_server.jsxs)(_components.span, {
									...
									children: [
										...
										(0, import_jsx_runtime_react_server.jsx)(_components.span, {
											...
											children: " localhost.localdomain"
										}),
										(0, import_jsx_runtime_react_server.jsx)(_components.span, {
											style: {
												"--shiki-light": "#032F62",
										...
										(0, import_jsx_runtime_react_server.jsx)(_components.span, {
											...
											children: " localhost4.localdomain4"
										})
									]
								}),
								"\n",
								(0, import_jsx_runtime_react_server.jsxs)(_components.span, {
									...
									children: [
										...
										(0, import_jsx_runtime_react_server.jsx)(_components.span, {
											...
											children: " localhost6.localdomain6"
										})
									]
								}),
								"\n",
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.h3, {
							id: "24-memory-requirements",
							children: "2.4. Memory Requirements"
						}),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS requires at least 2 GB of memory to run in a test environment, and production environments require a minimum of 128 GB of memory." }),
						(0, import_jsx_runtime_react_server.jsx)(_components.h3, {
							id: "25-time-synchronization",
							children: "2.5. Time Synchronization"
						}),
						(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
							"Multi-node consistency must use time servers to maintain time consistency, otherwise services may not start. Related time servers include ",
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS requires time synchronization. You can use the following command to check time synchronization status:" }),
						(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
							className: "shiki shiki-themes github-light github-dark",
							style: {
								"--shiki-light": "#24292e",
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.h3, {
							id: "26-capacity-and-ec-planning",
							children: "2.6. Capacity and EC Planning"
						}),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "When planning object storage capacity, we recommend considering:" }),
						(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
							"\n",
							...
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "Planning cycle: How long do you hope this hardware planning can support? (recommended: 3 years)" }),
							"\n",
						...
						(0, import_jsx_runtime_react_server.jsxs)(_components.table, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.thead, { children: (0, import_jsx_runtime_react_server.jsxs)(_components.tr, { children: [
							...
							(0, import_jsx_runtime_react_server.jsx)(_components.th, { children: "Recommended Parity Level" }),
							...
							(0, import_jsx_runtime_react_server.jsxs)(_components.tr, { children: [
								...
								(0, import_jsx_runtime_react_server.jsx)(_components.td, { children: "Can tolerate up to 4 disk (or node) failures, achieving a good balance between reliability and storage efficiency." })
							] }),
							(0, import_jsx_runtime_react_server.jsxs)(_components.tr, { children: [
								(0, import_jsx_runtime_react_server.jsx)(_components.td, { children: "High Availability Requirements" }),
								(0, import_jsx_runtime_react_server.jsx)(_components.td, { children: "EC:4 - 8 or higher" }),
								(0, import_jsx_runtime_react_server.jsx)(_components.td, { children: "Suitable for scenarios with extremely high data availability requirements, but sacrifices more storage space." })
							] }),
							(0, import_jsx_runtime_react_server.jsxs)(_components.tr, { children: [
								...
								(0, import_jsx_runtime_react_server.jsx)(_components.td, { children: "Provides basic redundancy protection, suitable for non-critical business." })
							] })
						] })] }),
						(0, import_jsx_runtime_react_server.jsx)(_components.h3, {
							id: "27-disk-planning",
							children: "2.7. Disk Planning"
						}),
						(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
							"Due to NFS generating phantom writes and lock issues under high I/O conditions, ",
							(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "NFS is prohibited" }),
							" as the underlying storage medium when using RustFS. The official strongly recommends using ",
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "The reasons are as follows:" }),
						(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
							"\n",
							(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "Better Performance:" }), " RustFS's Erasure Coding engine is highly optimized and can directly read and write multiple disks concurrently, achieving higher throughput than hardware RAID controllers. Hardware RAID becomes a performance bottleneck."] }),
							"\n",
							...
							"\n",
							(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "Simpler Management:" }), " RustFS uniformly manages disks, simplifying storage layer operations and maintenance."] }),
							"\n",
							(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "Faster Fault Recovery:" }), " RustFS healing process is faster than traditional RAID rebuild and has less impact on cluster performance."] }),
							"\n"
						] }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "The recommended storage medium is NVMe SSD as your storage medium on disks to ensure higher performance and throughput." }),
						(0, import_jsx_runtime_react_server.jsx)(_components.h3, {
							id: "28-file-system-selection",
							children: "2.8. File System Selection"
						}),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "For disk file system formatting, RustFS strongly recommends using XFS file system on all disks used for storage. RustFS development and testing are based on XFS, ensuring optimal performance and stability. Avoid using other file systems such as ext4, BTRFS, or ZFS, as they may cause performance degradation or unpredictable issues." }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "RustFS is an object storage system designed for high concurrency and high performance. When clients upload or download large objects, RustFS will shard them and read/write to multiple disks in the erasure set in parallel." }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "XFS advantages: XFS (eXtents File System) was designed from the beginning for high performance and scalability. It performs extremely well in large file processing and high-concurrency I/O scenarios. Its internal journaling and data structures (such as B+ trees) can efficiently handle large numbers of parallel read/write requests, which perfectly matches RustFS's working mode. In comparison, although file systems like ext4 have made great performance improvements in recent years, when facing extreme concurrent loads, XFS usually provides more stable and superior throughput." }),
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Object storage typically needs to handle massive numbers of files and huge individual files (TB level). XFS is a 64-bit file system that can support extremely large file sizes (up to 8 EB) and file system scale. Its metadata management is very efficient, and even with millions of files in a single directory, its performance degradation is much less than other file systems. This is crucial for RustFS's approach of storing each object (or version of an object) as an independent file on the backend file system." }),
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Use the following formatting command:" }),
						(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
							className: "shiki shiki-themes github-light github-dark",
							style: {
								"--shiki-light": "#24292e",
						...
						(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
							...
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "-n ftype=1: Enable ftype functionality. This allows the file system to record file types in the directory structure, which can improve performance of operations like readdir and unlink, beneficial for RustFS." }),
							"\n"
						] }),
				...
				(0, import_jsx_runtime_react_server.jsxs)(_components.div, {
					...
					children: [
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "For RustFS startup, we recommend configuring a dedicated user without login permissions to start RustFS services. In the rustfs.service startup control script." }),
						(0, import_jsx_runtime_react_server.jsxs)(_components.ol, { children: [
							"\n",
							(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
								(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "Do not modify default startup account:" }),
								" The default user and group are ",
							...
							"\n",
							(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.strong, { children: "Modify default startup account:" }), " You can use the groupadd and useradd commands to create users and groups, then modify the username and password in the systemctl startup configuration file after adding."] }),
							"\n"
						] }),
							...
							children: (0, import_jsx_runtime_react_server.jsxs)(_components.code, { children: [
								(0, import_jsx_runtime_react_server.jsx)(_components.span, {
									...
									children: (0, import_jsx_runtime_react_server.jsx)(_components.span, {
										...
										children: "# Multiple node multiple disk mode"
									})
								}),
								"\n",
								(0, import_jsx_runtime_react_server.jsxs)(_components.span, {
				...
				(0, import_jsx_runtime_react_server.jsxs)(_components.div, {
					...
					children: [
						...
						(0, import_jsx_runtime_react_server.jsxs)(_components.ol, { children: [
							"\n",
							(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "Start service and set auto-start" }),
							"\n"
						] }),
						(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
							className: "shiki shiki-themes github-light github-dark",
						...
						(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "Enter the server's IP address and port to try accessing the console. The interface you see is as follows:" }),
