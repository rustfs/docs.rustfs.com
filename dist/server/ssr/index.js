import { i as __toESM, t as __commonJSMin } from "./assets/rolldown-runtime-B4lejLz5.js";
import { n as require_jsx_runtime, t as require_react } from "./assets/react-BKYDRtZ1.js";
import { t as require_react_dom } from "./assets/react-dom-QgUhXYPF.js";
import { n as INTERNAL_ServerRoot } from "./assets/client-DtWGx4aQ.js";
...
//#endregion
//#region node_modules/@vitejs/plugin-rsc/dist/shared-BVLpj0Y8.js
...
var client_references_default = {
	"becc1a081aff": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_becc1a081aff;
	},
	"0817f5b3b49f": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_0817f5b3b49f;
	},
	"327bb606fa81": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_327bb606fa81;
	},
	"e70dc53bce46": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_e70dc53bce46;
	},
	"859200a8131f": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_859200a8131f;
	},
	"4e8efe524788": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_4e8efe524788;
	},
	"339f946bc456": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_339f946bc456;
	},
	"847a2b1045ef": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_847a2b1045ef;
	},
	"6d786e16fc6b": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_6d786e16fc6b;
	},
	"d29067c5123b": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_d29067c5123b;
	},
	"0555c9fe9bc1": async () => {
		return (await import("./assets/framework-8fDnx5a7.js")).export_0555c9fe9bc1;
	},
	"c1a625c0fb46": async () => {
		return (await import("./assets/docs-CN0kl3s9.js")).export_c1a625c0fb46;
	},
	"40036365f8f4": async () => {
		return (await import("./assets/docs-CN0kl3s9.js")).export_40036365f8f4;
	},
	"1015cf8d22ee": async () => {
		return (await import("./assets/not-found-BXeNkU7x.js")).export_1015cf8d22ee;
	},
	"5ea31104ddfe": async () => {
		return (await import("./assets/client-DFUgjjVV.js")).export_5ea31104ddfe;
	},
	"16c5e792d2ee": async () => {
		return (await import("./assets/flexsearch-static-D04JfW-T.js")).export_16c5e792d2ee;
	},
	"79245c25971e": async () => {
		return (await import("./assets/root-jL7_fJSY.js")).export_79245c25971e;
	}
};
//#endregion
...
var renderHtmlStream = async (rscStream, rscHtmlStream, options) => {
	...
	try {
		...
		htmlStream = await (0, import_server_edge.renderToReadableStream)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("html", { children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)("body", {}) }), {
			bootstrapScriptContent: getBootstrapPreamble({ hydrate: false }) + bootstrapScriptContent + (options.extraScriptContent || ""),
			...options.nonce ? { nonce: options.nonce } : {}
		});
	}
	return {
...
async function renderHtmlFallback() {
	const bootstrapScriptContent = await loadBootstrapScriptContent();
	return html_shell_default.replace("</body>", () => `<script>${bootstrapScriptContent}<\/script></body>`);
}
function loadBootstrapScriptContent() {
	return Promise.resolve(assetsManifest.bootstrapScriptContent);
}
//#endregion
export { renderHtmlFallback as INTERNAL_renderHtmlFallback, renderHtmlStream as INTERNAL_renderHtmlStream };
