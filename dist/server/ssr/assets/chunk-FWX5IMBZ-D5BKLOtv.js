...
import { b as getConfig, s as common_default } from "./chunk-WYO6CB5R-DD19QnnH.js";
import { d as interpolateToCurve } from "./chunk-ICXQ74PX-D20awcLa.js";
import { a as insertNode, i as insertCluster, s as labelHelper } from "./chunk-ZGVPDNZ5-CzWdwYTn.js";
import { a as markers_default, i as insertEdgeLabel, o as positionEdgeLabel, r as insertEdge } from "./chunk-52WLFC77-BjbtEoi8.js";
...
(/* @__PURE__ */ __name(() => {
	registerLayoutLoaders([
		{
			name: "dagre",
			loader: /* @__PURE__ */ __name(async () => await import("./dagre-VKFMJZFB-BJV_7VUu.js"), "loader")
		},
		{
			name: "swimlane",
			loader: /* @__PURE__ */ __name(async () => await import("./swimlanes-5IMT3BWC-D_BbsBDN.js"), "loader")
		},
		...[{
			name: "cose-bilkent",
			loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-JH36ORCC-DOXgAYat.js"), "loader")
		}]
	]);
